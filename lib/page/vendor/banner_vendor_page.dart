...
class BannerVendorPage extends StatefulWidget {
  String vendorIds;
  BannerVendorPage(this.vendorIds, {super.key});

  @override
  _BannerVendorPageState createState() => _BannerVendorPageState();
}

class _BannerVendorPageState extends StateMVC<BannerVendorPage> {

  late HomeController _con;

  _BannerVendorPageState() : super(HomeController()) {
  ...
  void initState() {
    ...
    super.initState();
    _con.listBannerVendor(widget.vendorIds);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:  AppBar(
        ...
        title: Text("",style: TextStyle(color: Colors.white,fontFamily: AppStyle.robotoRegular,fontSize: 16),),
        centerTitle: true,
      ),
