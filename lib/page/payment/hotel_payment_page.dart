...
class HotelPaymentPage extends StatefulWidget {
  double totalPrice;
  HotelPaymentPage(this.totalPrice, {super.key});

  @override
  _HotelPaymentPageState createState() => _HotelPaymentPageState();
}

class _HotelPaymentPageState extends StateMVC<HotelPaymentPage> {

  late AuthController _con;

  _HotelPaymentPageState() : super(AuthController()) {
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                SizedBox(height: 10,),
                                Text(
                                  "Amount Payable: ${ApiConstants.currency}${widget.totalPrice.round()}",
