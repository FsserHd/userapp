...
class InsideLoginPage extends StatefulWidget {
  const InsideLoginPage({super.key});

  @override
  _InsideLoginPageState createState() => _InsideLoginPageState();
}

class _InsideLoginPageState extends StateMVC<InsideLoginPage> {

  late AuthController _con;

  _InsideLoginPageState() : super(AuthController()) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:  AppBar(
        ...
        title: Text("Login",style: TextStyle(color: Colors.white,fontFamily: AppStyle.robotoRegular,fontSize: 16),),
        centerTitle: true,
      ),
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: (){
                    _con.insideLogin(context,mobileController.text);
