...
class InsideOtpPage extends StatefulWidget {

  String mobile;
  String? id;
  InsideOtpPage(this.mobile,this.id, {super.key});

  @override
  _InsideOtpPageState createState() => _InsideOtpPageState();
}

class _InsideOtpPageState extends StateMVC<InsideOtpPage> {
  late AuthController _con;

  _InsideOtpPageState() : super(AuthController()) {
